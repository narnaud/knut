...
QtTsView::QtTsView(QWidget *parent)
    ...
    , m_searchableViewInterface(new SearchableViewInterface(m_tableView))
    ...
    , m_contentProxyModel(new QtTsProxy(this))
{
    ...
    m_searchableViewInterface->updateItemDelegate();
...
{
    m_searchableViewInterface->find(searchText, options);
}
